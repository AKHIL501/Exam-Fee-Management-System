...
<body>
    <div id="wrapper">
		...
		Statement st = cn.createStatement();
		            ...
		            st.executeUpdate("UPDATE fee SET id='" + id+ "',userid='" + uid + "',htno='"+ htno + "',branch='" + branch + "',yr='" + year + "',firstyear='" + fiy + "',fiapnos='" + fnos+ "',fiamount='" + famt + "',fitype='" + ffir + "',sfyear='" + sf + "',sfapnos='"+ tonos + "',sfamount='" + toamt + "',sftype='" + sfs + "',ssyear='" + ss+ "',ssapnos='" + ttnos + "',ssamount='" + ttamt + "',sstype='" + sss + "',tfyear='"+ tf + "',tfapnos='" + thonos + "',tfamount='" + thoamt + "',tftype='" + tfs+ "',tsyear='" + tf + "',tsapnos='" + thtnos + "',tsamount='" + thtamt + "',tstype='"+ tss + "',ffyear='" + ff + "',ffapnos='" + fonos + "',ffamount='" + foamt+ "',fftype='"+ffs+"',fsyear='" + fs + "',fsapnos='" + ftnos + "',fsamount='"+ ftamt + "',fstype='" + fss + "',date='" + date + "' WHERE id='"+id+"'");		
		...
		ResultSet rs = st.executeQuery("select * from fee where id='"+ id + "' and date='" + date + "'");
	...
	<table align="center">
		<tr>
			<th colspan="3">Student Copy (To be retained by the student for
				reference)</th>
		</tr>
	...
	<table align="center">
		...
		<tr>
			<td><input type="button" value="PRINT"
				onclick="javascipt:window.print()" /></td>
			<td><a href="btech.jsp">BACK</a></td>
		</tr>
	</table>
